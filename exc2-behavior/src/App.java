public class App {
    ...
    public static void main(String[] args) {
        ...
        sortByName(students);
        //TODO (elimineu sortByName i feu la nova crida a sort)
        //Imprimim
        ...
        sortByAge(students);
        //TODO (elimineu sortByAge i feu la nova crida a sort)
        //Imprimim
        ...
        //TODO (elimineu sortByAmountOfEnrolledSubjects
        // i feu la nova crida a sort)
        //Imprimim
        printStudents(students, "Llista ordenada per assignatures:");

    }

    static void sort(Student[] students, StudentComparator comp){
        //TODO
    }
    ...
    static void sortByAmountOfEnrolledSubjects(Student[] students){
        Arrays.quickSortByAmountOfEnrolledSubjects(students, 0, students.length - 1);
    }
